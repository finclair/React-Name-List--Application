...
const NameListItem = (props) => {
  ...
  const modifyingPerson = props.modifyingPerson;
  return (
    <div className="row person">
      ...
      <div className="buttons-column">
        <button onClick={() => modifyingPerson(person.id)} className="button-modify"><span className="glyphicon glyphicon-pencil" aria-hidden="true"></span></button>
